    ...
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">Ahmad Gazea</a>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h2 class="home__subtitle">Join me to build <br>athletically toned muscles .</h2>
                    </div>
                   <!-- <img src="IMG-20220130-WA0036.jpg" alt="" class="home__img"> -->
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Get the body<br>you deserve </h2>
                        <p class="about__description">I'm a Personal Trainer & body transformation coach , help you to lose weight, buld muscle, train for an event ,sport or improve your general fitness in both person and online .</p>
                    
                    </div>

                    <img src="IMG-20211218-WA0010.jpg" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Diet Plans</h3>
                        <p class="services__description">Choose from General, Vegetarian, Vegan, Gluten Free and Dairy Free meals.</p>
                    </div>

                    <div class="services__content">
                        <svg class="services__img"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                   ...
                   <g>
                        ...
                        <h4 class="services__title">Personal Training</h4>
                        <p class="services__description">To Be The Best ,
                            YOU Have To Train With The Beast . Great Outcomes Require Hard Efforts .</p>
                    </div>

                    <div class="services__content">
                        <svg class="services__img" xmlns="http://www.w3.org/2000/svg"><g><path d="M31.9,39.5h6A1.42,1.42,0,0,0,39.4,38V14a1.42,1.42,0,0,0-1.5-1.5h-6A1.42,1.42,0,0,0,30.4,14V38A1.42,1.42,0,0,0,31.9,39.5Z"/><path d="M45.4,39.5h3A1.42,1.42,0,0,0,49.9,38V14a1.42,1.42,0,0,0-1.5-1.5h-3A1.42,1.42,0,0,0,43.9,14V38A1.42,1.42,0,0,0,45.4,39.5Z"/><path d="M25,39.5h0A1.37,1.37,0,0,0,26.5,38V14A1.42,1.42,0,0,0,25,12.5h0A1.42,1.42,0,0,0,23.5,14V38A1.37,1.37,0,0,0,25,39.5Z"/><path d="M16.6,39.5H18A1.42,1.42,0,0,0,19.5,38V14A1.42,1.42,0,0,0,18,12.5H16.5A1.42,1.42,0,0,0,15,14V38A1.45,1.45,0,0,0,16.6,39.5Z"/><path d="M3.6,39.5h6A1.42,1.42,0,0,0,11.1,38V14a1.42,1.42,0,0,0-1.5-1.5h-6A1.42,1.42,0,0,0,2.1,14V38A1.47,1.47,0,0,0,3.6,39.5Z"/></g></svg>
                        <h3 class="services__title">Products</h3>
                        <p class="services__description">We provide our customers with quality services for many years, with the best nutritional supplements .</p>
                    </div>
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <h2 class="section-title contact__initial">Contact me</h2>
                        <p class="contact__description">For more Information , Training , and Dite Plan - please click on the link below to Touch with me .</p>
                    </div>
                </div>
            </section>
        </main>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Ahmad Gazea</a>
                    <span class="footer__description">Personal Trainer</span>
                    <div>
                        <a href="https://www.facebook.com/ahmad.gazea.9?mibextid=ZbWKwL" class="footer__social"><i class='bx bxl-facebook'></i></a>
                        <a href="https://instagram.com/ahmadgazea?igshid=MzRlODBiNWFlZA==" class="footer__social"><i class='bx bxl-instagram'></i></a>
                        <a href="https://wa.me+963930933328" class="footer__social"><i class='bx bxl-whatsapp'></i></a>
                    </div>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="#" class="footer__link">Diet Plans</a></li>
                        <li><a href="#" class="footer__link">Personal Training</a></li>
                ...
                <div class="footer__content">
                    <h3 class="footer__title">Adress Email</h3>
                    <ul>
                        <li>Ahmad-Gazea</li>
                        <li><a href="Ahmad.gazea09@gmail.com" class="footer__link"> Ahmad.gazea09@gmail.com</a></li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2022 amanesmade. All right reserved</p>
        </footer>
